  ...
  class FindDirectoryView extends OutcomesDirectoryView
    ...
    initialize: (opts) ->
      ...
      account = new OutcomeGroup
        ...
        description: I18n.t('account_standards_description', "To the left you'll notice the standards your institution has created for you to use in your projects.")
      ...
      if ENV.STATE_STANDARDS_URL
        state = new OutcomeGroup
          ...
          description: I18n.t('state_standards_description', "To the left you'll see a folder for each state with their updated state standards. This allows for you to painlessly include state standards for grading within your project.")
      ...
      if ENV.COMMON_CORE_GROUP_URL
        core = new OutcomeGroup
          ...
          description: I18n.t('common_core_description', "To the left is the familiar outcomes folder structure for each grouping of the Common Core State Standards. This will allow you to effortlessly include any of the Common Core Standards for grading within your project.")
