...
class Account < ActiveRecord::Base
  ...
  def tabs_available(user=nil, opts={})
    ...
    if site_admin?
      ...
      tabs << { :id => TAB_GRADING_STANDARDS, :label => t('#account.tab_grading_standards', "Evaluation Schemes"), :css_class => 'grading_standards', :href => :account_grading_standards_path } if user && self.grants_right?(user, nil, :manage_grades)
