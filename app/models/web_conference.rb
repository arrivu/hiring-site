...
class WebConference < ActiveRecord::Base
  ...
  def admin_join_url(user, return_to="http://www.arrivuapps.com")
    raise "not implemented"
  end
  
  def participant_join_url(user, return_to="http://www.arrivuapps.com")
    raise "not implemented"
  end
  ...
  def craft_url(user=nil,session=nil,return_to="http://www.arrivuapps.com")
