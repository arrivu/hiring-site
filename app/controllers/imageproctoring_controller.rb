class ImageproctoringController < ApplicationController
  ...
  def image_proctoring
    ...
    respond_to do |format|
      ...
      Imageproctoring.create!(imageData: thumbnail_image_url(@attachment.id, @attachment.uuid), user_id: @current_user.id, quiz_id: params[:quiz_id], time_elapsed: params[:time_elapsed])
    end
    #end
