...
class ApplicationController < ActionController::Base
  ...
  def unsupported_browser
    t("#application.warnings.unsupported_browser", "Your browser does not meet the minimum requirements for SublimeHiring. Please visit the *SublimeHiring Guides* for a complete list of supported browsers.", :wrapper => @template.link_to('\1', 'http://guides.arrivuapps.com/s/2204/m/4214/l/41056-which-browsers-does-canvas-support'))
  end
