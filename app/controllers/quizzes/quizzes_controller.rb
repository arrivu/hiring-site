...
class Quizzes::QuizzesController < ApplicationController
  ...
  def take_quiz
    ...
    @image_proctoring = Imageproctoring.find_all_by_quiz_id_and_user_id_and_submission_id_and_attempt(@submission[:quiz_id],@submission[:user_id],@submission[:submission_id],@submission[:quiz_version_id])
